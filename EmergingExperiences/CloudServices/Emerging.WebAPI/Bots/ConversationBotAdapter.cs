...
{
    public class ConversationBotAdapter:BotAdapter
    {
        public ConversationBotAdapter():base()
        {

        }

        // Adds middleware to the adapter's pipeline.
        public new ConversationBotAdapter Use(IMiddleware middleware)
        {
            base.Use(middleware);
            return this;
        }
        ...
        public async Task ProcessActivityAsync(BotCallbackHandler callback = null, string msg = "")
        {
            //while (true)
            //{
